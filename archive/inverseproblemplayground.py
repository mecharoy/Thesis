...
CONFIG = {
    ...
    'OPT_ATOL': 1e-12,    # Much tighter tolerance to prevent premature convergence
    'OPT_TOL': 0.001,     # Relative tolerance (default is 0.01)
    'OPT_STRATEGY': 'best1bin',  # Mutation strategy (best1bin, randtobest1bin, best2bin, rand2bin, rand1bin)
    'OPT_MUTATION': (0.5, 1.5),  # Mutation factor range for better exploration
    ...
    'USE_MULTI_STAGE_OPTIMIZATION': False,  # Enable multi-stage refinement
    ...
    if method == 'differential_evolution':
        ...
        def wrapped_objective_with_logging(x_opt, target_stats, cae, surrogate_model, params_scaler, fixed_params):
            ...
            try:
                ...
                # Track trajectory for animations
                if save_animations and optimization_trajectory is not None:
                    ...
                    optimization_trajectory['iterations'].append(iteration_counter[0])
